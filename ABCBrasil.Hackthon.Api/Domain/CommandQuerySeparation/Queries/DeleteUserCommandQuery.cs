...
namespace ABCBrasil.Hackthon.Api.Domain.CommandQuerySeparation.Queries
{
    ...
    [SwaggerSchema("Payload para excluir um usuário", Title = "DeleteUserRequest", Required = ["Id"])]
    public class DeleteUserCommandQuery : IRequest<Try<List<NotificationBase>, ApiResponse<bool>>>
    {
        /// <summary>
